...
Rain_BR_ts <- ts(Rainfall_BR_processed$Rainfall, start=c(1901,1), frequency=12)
...
Rain_BR_Decomposed <- stl(Rain_BR_ts, s.window = "periodic")

plot(Temp_BR_Decomposed)
plot(Rain_BR_Decomposed)
...
Rain_BR_components <- as.data.frame(Rain_BR_Decomposed$time.series[,1:3])
Rain_BR_components <- mutate(Rain_BR_components,
