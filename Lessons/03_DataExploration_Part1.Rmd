...
> Answer: Shows attached packages
...
str(USGS.flow.data) #shows all objects of data frame
dim(USGS.flow.data)
...
> Answer: Favorable: Time series analysis; Non-favorable: just working with data that we have, maybe in habitat modeling where we need rows that have values for all predictor variables
