...
#high p-value means it is normally distributed, low p-value means reject the null hypothesis that the data are normally distributed
...
#low p-value -- reject null hyp that variancees are not equal
...
#shows that not all group means are equal
...
#groups treatment groups with same mean
...
#reject null hyp that mean across groups in the same
