...
When we import data to R, data frame is the preferred way for storing the data because columns can have different modes (character, numeric, integer, logical, complex). But all columns need same number of rows.
...
#Option 1
df <- cbind(df_car_speed,car_dist)  #similarly rows could be added using rbind() #cbind=colunn bind, both objects need to have same # of rows
class(df)
df
